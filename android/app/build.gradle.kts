...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.example.roster_champ"
        ...
        manifestPlaceholders += mapOf(
            "appAuthRedirectScheme" to "rosterchamp"
        )
    }
    ...
    buildTypes {
        release {
            // Use the release keystore when available, otherwise fall back to debug for local builds.
